...
#//TODO: ask Nux how to test error code -2 (sharable devices)
...
SET r0 99      #non-existant device
PUSH r0        #push argument on stack
SET r4 3       #OPEN sys call id
PUSH r4        #push sys call id on stack
TRAP           #open the device (which does not exist)

#save the error code
POP r4         #save the value in r4

#Write the error value to the console
SET r0 1       #device #1 (console output)
...
#
#at this point we should be printing a -1 to the console
#

#Try to re-open the console device
SET r0 1       #device #1 (console output)
PUSH r0        #push argument on stack
SET r4 3       #OPEN sys call id
PUSH r4        #push sys call id on stack
...
#
#at this point we should be printing a -3 to the console
#
...
#
#at this point we should be printing a -4 to the console
#
...
#
#at this point the keyboard device has been opened
#
...
#
#at this point we should be printing a -5 to the console
#

#Read from the write only console
SET r0 1       #device #1 (keyboard)
PUSH r0        #push device number
PUSH r0        #push address (arg not used by this device so any val will do)
...
#
#at this point we should be printing a -6 to the console
#
